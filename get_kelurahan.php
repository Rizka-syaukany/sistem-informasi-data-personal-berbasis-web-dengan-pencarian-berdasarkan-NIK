<?php
	...
	$query = "SELECT DISTINCT alamat.id_kelurahan,kelurahan.nama_kelurahan FROM alamat INNER JOIN kelurahan ON alamat.id_kelurahan=kelurahan.id_kelurahan AND alamat.id_kecamatan=?";
